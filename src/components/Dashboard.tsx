...
import { routes, notifications as initialNotifications, initialChartData, scheduleData } from '../data/mockData';
import { Route, Notification, ChartData } from '../types';

export const Dashboard: React.FC = () => {
  const [selectedRoute, setSelectedRoute] = useState<string | null>('downtown-express');
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'overview':
        return selectedRouteData ? <RouteComparison route={selectedRouteData} /> : null;
      case 'analytics':
